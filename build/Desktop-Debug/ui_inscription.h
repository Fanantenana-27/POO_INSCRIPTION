...
public:
    ...
    void setupUi(QMainWindow *Inscription)
    {
        ...
        Inscription->resize(1035, 600);
        actionOuvrir_un_fichier = new QAction(Inscription);
        ...
        frame_3->setGeometry(QRect(30, -10, 1019, 559));
...
"border-radius:10px"));
        ...
        toolBar = new QToolBar(Inscription);
        toolBar->setObjectName(QString::fromUtf8("toolBar"));
        Inscription->addToolBar(Qt::TopToolBarArea, toolBar);
    ...
    void retranslateUi(QMainWindow *Inscription)
    {
        ...
        actionOuvrir_un_fichier->setText(QCoreApplication::translate("Inscription", "Ouvrir un fichier", nullptr));
        actionEnregistrer->setText(QCoreApplication::translate("Inscription", "Enregistrer", nullptr));
        ...
        toolBar->setWindowTitle(QCoreApplication::translate("Inscription", "toolBar", nullptr));
    } // retranslateUi
